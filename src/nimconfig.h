...
#ifndef CONFIG_BT_NIMBLE_PINNED_TO_CORE_DISABLED
#ifndef CONFIG_BT_NIMBLE_PINNED_TO_CORE
#define CONFIG_BT_NIMBLE_PINNED_TO_CORE 0
#endif
#endif

#ifndef CONFIG_BT_NIMBLE_HOST_TASK_STACK_SIZE_DISABLED
...
#ifndef CONFIG_BT_NIMBLE_MEM_ALLOC_MODE_INTERNAL
#define CONFIG_BT_NIMBLE_MEM_ALLOC_MODE_INTERNAL 1
#endif
#endif

#ifndef CONFIG_BT_NIMBLE_MAX_CONNECTIONS_DISABLED
#ifndef CONFIG_BT_NIMBLE_MAX_CONNECTIONS
#define CONFIG_BT_NIMBLE_MAX_CONNECTIONS 3
#endif
#endif

#ifndef CONFIG_BT_NIMBLE_MAX_BONDS_DISABLED
#ifndef CONFIG_BT_NIMBLE_MAX_BONDS
#define CONFIG_BT_NIMBLE_MAX_BONDS 3
#endif
#endif

#ifndef CONFIG_BT_NIMBLE_MAX_CCCDS_DISABLED
#ifndef CONFIG_BT_NIMBLE_MAX_CCCDS
#define CONFIG_BT_NIMBLE_MAX_CCCDS 8
#endif
#endif

#ifndef CONFIG_BT_NIMBLE_SVC_GAP_DEVICE_NAME_DISABLED
#ifndef CONFIG_BT_NIMBLE_SVC_GAP_DEVICE_NAME
#define CONFIG_BT_NIMBLE_SVC_GAP_DEVICE_NAME "nimble"
#endif
#endif

#ifndef CONFIG_BT_NIMBLE_ATT_PREFERRED_MTU_DISABLED
#ifndef CONFIG_BT_NIMBLE_ATT_PREFERRED_MTU
#define CONFIG_BT_NIMBLE_ATT_PREFERRED_MTU 255
#endif
#endif

#ifndef CONFIG_BT_NIMBLE_SVC_GAP_APPEARANCE_DISABLED
...
#elif !defined(CONFIG_BT_NIMBLE_MSYS_1_BLOCK_COUNT) && !defined(CONFIG_BT_NIMBLE_MSYS_1_BLOCK_COUNT_DISABLED)
#define CONFIG_BT_NIMBLE_MSYS_1_BLOCK_COUNT 12
#endif

#ifndef CONFIG_BT_NIMBLE_MSYS_1_BLOCK_SIZE_DISABLED
#ifndef CONFIG_BT_NIMBLE_MSYS_1_BLOCK_SIZE
#define CONFIG_BT_NIMBLE_MSYS_1_BLOCK_SIZE 256
#endif
#endif

#ifndef CONFIG_BT_NIMBLE_RPA_TIMEOUT_DISABLED
#ifndef CONFIG_BT_NIMBLE_RPA_TIMEOUT
#define CONFIG_BT_NIMBLE_RPA_TIMEOUT 900
#endif
#endif

#ifndef CONFIG_BT_NIMBLE_LOG_LEVEL_DISABLED
#ifndef CONFIG_BT_NIMBLE_LOG_LEVEL
#define CONFIG_BT_NIMBLE_LOG_LEVEL 5
#endif
#endif

#ifndef CONFIG_NIMBLE_STACK_USE_MEM_POOLS_DISABLED
...
#ifndef CONFIG_BT_NIMBLE_L2CAP_COC_MAX_NUM_DISABLED
...
#ifndef CONFIG_BT_NIMBLE_NVS_PERSIST_DISABLED
...
#ifndef CONFIG_BT_NIMBLE_SM_SC_DISABLED
...
#ifndef CONFIG_BT_NIMBLE_GAP_DEVICE_NAME_MAX_LEN_DISABLED
#ifndef CONFIG_BT_NIMBLE_GAP_DEVICE_NAME_MAX_LEN
#define CONFIG_BT_NIMBLE_GAP_DEVICE_NAME_MAX_LEN 31
#endif
#endif

/** @brief ACL Buffer count */
#ifndef CONFIG_BT_NIMBLE_TRANSPORT_ACL_FROM_LL_COUNT_DISABLED
#ifndef CONFIG_BT_NIMBLE_ACL_BUF_COUNT
#define CONFIG_BT_NIMBLE_TRANSPORT_ACL_FROM_LL_COUNT 12
#else
#define CONFIG_BT_NIMBLE_TRANSPORT_ACL_FROM_LL_COUNT CONFIG_BT_NIMBLE_ACL_BUF_COUNT
#endif
#endif

/** @brief ACL Buffer size */
#ifndef CONFIG_BT_NIMBLE_TRANSPORT_ACL_SIZE_DISABLED
#ifndef CONFIG_BT_NIMBLE_TRANSPORT_ACL_SIZE
#define CONFIG_BT_NIMBLE_TRANSPORT_ACL_SIZE 255
#endif
#endif

/** @brief Transport (HCI) Event Buffer size */
#ifndef CONFIG_BT_NIMBLE_TRANSPORT_EVT_SIZE_DISABLED
...
#ifndef CONFIG_BT_NIMBLE_TRANSPORT_EVT_COUNT_DISABLED
...
#ifndef CONFIG_BT_NIMBLE_TRANSPORT_EVT_DISCARD_COUNT_DISABLED
#ifndef CONFIG_BT_NIMBLE_TRANSPORT_EVT_DISCARD_COUNT
#define CONFIG_BT_NIMBLE_TRANSPORT_EVT_DISCARD_COUNT 8
#endif
#endif

#ifndef CONFIG_BT_NIMBLE_L2CAP_COC_SDU_BUFF_COUNT_DISABLED
#ifndef CONFIG_BT_NIMBLE_L2CAP_COC_SDU_BUFF_COUNT
#define CONFIG_BT_NIMBLE_L2CAP_COC_SDU_BUFF_COUNT 1
#endif
#endif

#ifndef CONFIG_BT_NIMBLE_EATT_CHAN_NUM_DISABLED
#ifndef CONFIG_BT_NIMBLE_EATT_CHAN_NUM
#define CONFIG_BT_NIMBLE_EATT_CHAN_NUM 0
#endif
#endif

#ifndef CONFIG_BT_NIMBLE_SVC_GAP_CENT_ADDR_RESOLUTION_DISABLED
#ifndef CONFIG_BT_NIMBLE_SVC_GAP_CENT_ADDR_RESOLUTION
#define CONFIG_BT_NIMBLE_SVC_GAP_CENT_ADDR_RESOLUTION -1
#endif
#endif

#ifndef CONFIG_BT_NIMBLE_GATT_MAX_PROCS_DISABLED
#ifndef CONFIG_BT_NIMBLE_GATT_MAX_PROCS
#define CONFIG_BT_NIMBLE_GATT_MAX_PROCS 4
#endif
#endif

#ifndef CONFIG_BT_NIMBLE_HS_STOP_TIMEOUT_MS_DISABLED
#ifndef CONFIG_BT_NIMBLE_HS_STOP_TIMEOUT_MS
#define CONFIG_BT_NIMBLE_HS_STOP_TIMEOUT_MS 2000
#endif
#endif

#ifndef CONFIG_BT_ENABLED_DISABLED
#ifndef CONFIG_BT_ENABLED
#define CONFIG_BT_ENABLED
#endif
#endif

#ifndef CONFIG_BT_NIMBLE_ENABLED_DISABLED
#ifndef CONFIG_BT_NIMBLE_ENABLED
#define CONFIG_BT_NIMBLE_ENABLED 1
#endif
#endif

#ifndef CONFIG_BT_CONTROLLER_ENABLED_DISABLED
#ifndef CONFIG_BT_CONTROLLER_ENABLED
#define CONFIG_BT_CONTROLLER_ENABLED 1
#endif
#endif

#ifndef CONFIG_BT_NIMBLE_CRYPTO_STACK_MBEDTLS_DISABLED
#ifndef CONFIG_BT_NIMBLE_CRYPTO_STACK_MBEDTLS
#define CONFIG_BT_NIMBLE_CRYPTO_STACK_MBEDTLS 0
#endif
#endif

#ifndef MYNEWT_VAL_BLE_CRYPTO_STACK_MBEDTLS_DISABLED
...
#ifndef CONFIG_BT_NIMBLE_HS_FLOW_CTRL_DISABLED
#define CONFIG_BT_NIMBLE_HS_FLOW_CTRL 1
#endif
#ifndef CONFIG_BT_NIMBLE_HS_FLOW_CTRL_ITVL_DISABLED
#define CONFIG_BT_NIMBLE_HS_FLOW_CTRL_ITVL 1000
#endif
#ifndef CONFIG_BT_NIMBLE_HS_FLOW_CTRL_THRESH_DISABLED
#define CONFIG_BT_NIMBLE_HS_FLOW_CTRL_THRESH 2
#endif
#ifndef CONFIG_BT_NIMBLE_HS_FLOW_CTRL_TX_ON_DISCONNECT_DISABLED
...
#ifndef CONFIG_BT_NIMBLE_USE_ESP_TIMER_DISABLED
...
#if CONFIG_BT_NIMBLE_EXT_ADV
#  if !defined(CONFIG_BT_NIMBLE_MAX_EXT_ADV_INSTANCES) && !defined(CONFIG_BT_NIMBLE_MAX_EXT_ADV_INSTANCES_DISABLED)
#    define CONFIG_BT_NIMBLE_MAX_EXT_ADV_INSTANCES 1
#  endif
#  if !defined(CONFIG_BT_NIMBLE_MAX_EXT_ADV_DATA_LEN) && !defined(CONFIG_BT_NIMBLE_MAX_EXT_ADV_DATA_LEN_DISABLED)
#    define CONFIG_BT_NIMBLE_MAX_EXT_ADV_DATA_LEN 251
#  endif
#endif

/* Must set max number of syncs if periodic advertising is enabled */
#if CONFIG_BT_NIMBLE_ENABLE_PERIODIC_ADV && !defined(CONFIG_BT_NIMBLE_MAX_PERIODIC_SYNCS) && !defined(CONFIG_BT_NIMBLE_MAX_PERIODIC_SYNCS_DISABLED)
#  define CONFIG_BT_NIMBLE_MAX_PERIODIC_SYNCS 1
#endif
...
#ifndef CONFIG_NIMBLE_CPP_DEBUG_ASSERT_ENABLED_DISABLED
#ifndef CONFIG_NIMBLE_CPP_DEBUG_ASSERT_ENABLED
#define CONFIG_NIMBLE_CPP_DEBUG_ASSERT_ENABLED 0
#endif
#endif

#ifndef CONFIG_NIMBLE_CPP_FREERTOS_TASK_BLOCK_BIT_DISABLED
